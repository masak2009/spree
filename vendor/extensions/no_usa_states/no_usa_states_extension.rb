...
class NoUsaStatesExtension < Spree::Extension
  version "1.0"
  description "Describe your extension here"
  url "http://yourwebsite.com/no_usa_states"

  # Please use no_usa_states/config/routes.rb instead for extension routes.
